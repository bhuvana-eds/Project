...
/**
 * Servlet implementation class FormDataUpdateServlet2
 */
@WebServlet("/FormDataUpdateServlet2") // Maps the servlet to a URL pattern
@MultipartConfig // Allows the servlet to handle multipart/form-data requests
public class FormDataUpdateServlet2 extends HttpServlet {
