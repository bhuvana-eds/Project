...
<script>
	function displayImage(base64String) {
		...
		newTab.document
				.write('<img src="data:image/png;base64,' + base64String + '">');
	}
...
<body>
	<header>
		...
		<nav>
			<a href="mcreateform.jsp">Create Form</a> <a href="#" class="active">My
				Forms</a> <a href="ApprovalForm.jsp">Approve Forms</a>
		</nav>
	</header>
				...
				<tr>
					...
					<td><a href="#"
						onclick="displayImage('<%=formDataObj.get("Upload Document")%>')">View
							document</a></td>
					<td><%=status%></td>
					<td><%=formDataObj.get("Approved amount")%></td>
