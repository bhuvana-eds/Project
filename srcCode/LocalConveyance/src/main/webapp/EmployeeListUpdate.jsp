        ...
        <table id="expenseTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= userId %></td>
                    <td>
                    <select name="usertypeArray[]" required>
                        <option value="User" <%= "User".equals(userData.get("UserType")) ? "selected" : "" %>>User</option>
                        <option value="Approving Authority" <%= "Approving Authority".equals(userData.get("UserType")) ? "selected" : "" %>>Approving authority</option>
                        <option value="Finance" <%= "Finance".equals(userData.get("UserType")) ? "selected" : "" %>>Finance</option>
                    </select>
                    <input type="hidden" name="userIdArray[]" value="<%= userId %>">
                    </td>
                </tr>
                <% 
                    }
