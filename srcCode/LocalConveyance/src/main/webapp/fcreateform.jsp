...
<body>
    <header>
        ...
        <a href="fMyForms.jsp">My Forms</a>
    ...
    <main>
        ...
        <td><textarea name="particulars1" rows="2" class="formControl"></textarea><input name="status" id="status" type="hidden"></td>
        <td>
        ...
        function addRow() {
            ...
            // Remove 'required' attribute from all input, textarea, and select elements
            ...
            // Update the names of the input fields to avoid conflicts
