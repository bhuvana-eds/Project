...
<header class="index-main-section">
    <nav>
		<ul class="e_ul" onclick="activetab()">
            ...
            <li>
                <button id="btn-link" onclick="myFunction()" class="portal-dropbtn"> Rahul </button>
                <div id="myDropdown" class="portal-dropdown-content" style="width: 150px; right: 35px;">
                    <a href="emp_pwdchange.jsp">Change Password</a>
...
<body class="empportal-body">
        ...
        <form class="e-personal-form" action="#" name="admregisterForm">
            ...
            <div class="reg-user-details">
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Enter your name" value="Rahul J P">
                </div>
                <div class="input-box">
                    <span class="details">
                        Date of Birth * 
                    </span>
                    <input type="date" placeholder="Enter your dob" value="1999-11-16">
                </div>
                <div class="input-box">
                    <span class="details">
                        Father Name 
                    </span>
                    <input type="text" placeholder="Enter your father name" value="Praveen Kumar">
                </div>
                <div class="input-box">
                    <span class="details">
                        Mother Name 
                    </span>
                    <input type="text" placeholder="Enter your father name" value="Lakshmi P">
                </div>
                <div class="input-box">
                    <span class="details">
                        Phone Number * 
                    </span>
                    <input type="text" placeholder="Enter your number" value="8745236985">
                </div>
                ...
                <div class="input-box" style="margin-left: 41.5%;">
                    ...
                    <input type="text" placeholder="Enter your email" value="rahuljp@gmail.com" disabled>
                </div>
                ...
                <div class="input-box" style="margin-left: 47.5%; margin-top: 5%; position: absolute; width: 13.5%;">
                    ...
                    <input type="text" placeholder="Employee ID" value="123456" disabled>
                </div>
    ...
    <form class="e-addr-form" action="#" name="admregisterForm">
        ...
        <div class="reg-addr-details">
            <div class="input-box">
                ...
                <input type="text" placeholder="House No., Street name" value="#53, 5th B Cross, Jayanagar" id="caddress">
            </div>
            <div class="input-box">
                <span class="details">
                    City * 
            ...
            <div class="input-box">
                ...
                <input type="text" placeholder="pincode" value="560041" id="cpincode">
            </div>
            <div class="input-box">
                <span class="details">
                    Nationality * 
    ...
    <form class="e-addr-form" action="#" name="admregisterForm">
        ...
        <div class="reg-addr-details">
            <div class="input-box">
                ...
                <input type="text" placeholder="House No., Street name" value="#53, 5th B Cross, Jayanagar" id="paddress">
            </div>
            <div class="input-box">
                <span class="details">
                    City * 
            ...
            <div class="input-box">
                ...
                <input type="text" placeholder="pincode" value="560041" id="ppincode">
            </div>
        </div>
        </fieldset> 
    </form>
    ...
    <div class="section two" id="qualification">
        <br><br><br><br><br>
        <form class="e-qual-form" action="#" name="admregisterForm" id="qual-enable">
            ...
            <div id="show_item">
                <div class="reg-qual-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder=" " value="Computer Science Engineering">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Passing year * 
                        </span>
                        <input type="text" placeholder=" " value="2020">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Percentage/CGPA * 
                        </span>
                        <input type="text" placeholder=" " value="8.0">
                    </div>
                </div>	
                <div class="add-btn">
                    <button class="add_item_btn" id="add-btn">ADD</button>
                </div>	
            </div>
        </fieldset>
        </form>
	...
	<script>
		...
		$(document).ready(function(){
			$(".add_item_btn").click(function(e){
				e.preventDefault();
				$("#show_item").prepend(`<div class="reg-qual-div"><div class="reg-qual-details">
                                    <div class="input-box">
                                        <span class="details">
                                            Qualification * 
                                        </span>
    ...
    <div class="section three" id="work">
        <br><br><br><br><br>
        <form class="e-work-form" action="#" name="admregisterForm" id="work-enable">
            ...
            <div id="show_work_item">
                <div class="reg-work-details">
                    <div class="input-box">
                        ...
                        <input type="text" placeholder=" " value="LTIMindtree">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Designation * 
                        </span>
                        <input type="text" placeholder=" " value="Graduate Engineer Trainee">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Experience in months * 
                        </span>
                        <input type="text" placeholder=" " value="12">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Date of Leaving *
                        </span>
                        <input type="date" placeholder=" " value="2022-03-30">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Place of Work * 
                        </span>
                        <input type="text" placeholder=" " value="Bengaluru">
                    </div>
                    <div class="input-box">
                        <span class="details">
                            Skills * 
                        </span>
                        <input type="text" placeholder=" " value="Database, JAVA, Python">
                    </div>      
                </div>	
                <div class="add-btn">
