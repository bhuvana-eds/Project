		...
		<ul class="e_ul" onclick="activetab()">
            ...
            <li>
                ...
                <div id="myDropdown" class="portal-dropdown-content">
                    <a href="adm_registration.jsp">Initiate Employee Registration</a>
                    <a href="emp_list.jsp">View Employee Details</a>
    ...
    <div id="card" class="animated fadeIn">
        ...
        <div id="lower-side">
            <p id="message">
                ...
                Employee can login using the credentials sent to the registered email ID.
            </p>
            <a href="admportal_values.jsp" id="contBtn">OK</a>
        </div>
    </div>
</body>
