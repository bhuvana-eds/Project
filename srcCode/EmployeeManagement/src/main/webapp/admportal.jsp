...
<header class="index-main-section">
    <nav>
		<ul class="e_ul" onclick="activetab()">
            ...
            <li>
                <button id="btn-link" onclick="myFunction()" class="portal-dropbtn"> Admin </button>
...
<body class="empportal-body">
                          ...
                          <ol class="level-5-wrapper" id="h-ol">
                              <li>
                                <h6 class="level-5 rectangle" style="font-size: 18px;">
                                  Madhurya B
                                  <p id="hp"> Graduate Engineer - Trainee </p>
                                  <p id="hp"> Consulting </p>
                                </h6>
                              </li>
                          </ol>
    ...
    <form class="e-addr-form" action="#" name="admregisterForm">
        ...
        <div class="reg-addr-details">
            <div class="input-box">
                ...
                <input type="text" placeholder="House No., Street name" id="caddress">
            </div>
            <div class="input-box">
                <span class="details">
                    City *
            ...
            <div class="input-box">
                ...
                <input type="text" placeholder="state" id="cstate">
            </div>
            <div class="input-box">
                <span class="details">
                    Country *
                </span>
                <input type="text" placeholder="country" id="ccountry">
            </div>
            <div class="input-box">
                <span class="details">
                    Pincode *
                </span>
                <input type="text" placeholder="pincode" id="cpincode">
            </div>
            <div class="input-box">
                <span class="details">
                    Nationality *
    ...
    <form class="e-addr-form" action="#" name="admregisterForm">
        ...
        <input type="checkbox" id="addr" name="address" value="address" onchange="sameAddress()">
        ...
        <div class="reg-addr-details">
            <div class="input-box">
                ...
                <input type="text" placeholder="House No., Street name" id="paddress">
            </div>
            <div class="input-box">
                <span class="details">
                    City *
                </span>
                <input type="text" placeholder="city" id="pcity">
            </div>
            <div class="input-box">
                <span class="details">
                    State *
                </span>
                <input type="text" placeholder="state" id="pstate">
            </div>
            <div class="input-box">
                <span class="details">
                    Country *
                </span>
                <input type="text" placeholder="country" id="pcountry">
            </div>
            <div class="input-box">
                <span class="details">
                    Pincode *
                </span>
                <input type="text" placeholder="pincode" id="ppincode">
            </div>
        </div>
    </fieldset>
    </form>
